...
namespace Abp.VNext.Hello
{
    public class AuditLoggingService : ApplicationService
    {
        ...
        {
            return AuditLogRepository.GetListAsync(sorting, maxResultCount, skipCount = 0, startTime, endTime, httpMethod, url, userName, applicationName, correlationId, maxExecutionDuration, minExecutionDuration, hasException, httpStatusCode, includeDetails);
        }
