...
namespace Abp.VNext.Hello.ObjectExtending
{
    public static class HelloDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the HelloEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
